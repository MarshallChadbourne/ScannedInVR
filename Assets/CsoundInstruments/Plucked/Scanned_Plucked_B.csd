...
hslider bounds(32, 76, 150, 49) channel("paramone") range(0, 20, 10, 1, 0.1) text("param1"), 
hslider bounds(32, 142, 150, 50) channel("paramtwo") range(0, 100, 80, 1, 1) text("param2"), 
...
kParamOne chnget "paramone"
kParamTwo   chnget "paramtwo"
...
kbentpitch linseg 20, 1, 40, .5, 100, .2, 20

kpitchlfo oscil 2.9, 4
